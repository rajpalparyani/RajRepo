...
public class VectorTrafficProvider extends TileProvider
{
    public VectorTrafficProvider(AbstractMapConnector connector, 
            ITileListener listener, int tileCache)
    {
        super(new LongIntLRUCache(tileCache), connector, listener);
        super.streamer = new Streamer(AbstractStreamer.ACT_OLD_VECTOR_TRAFFIC_REQUEST);
    }
