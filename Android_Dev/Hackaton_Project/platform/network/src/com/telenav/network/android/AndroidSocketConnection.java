 ...
 *@date Jul 10, 2010
 */
class AndroidSocketConnection implements TnSocketConnection
{
    private Socket socket;
    private InetSocketAddress address; 
    private boolean timeout;
    
    AndroidSocketConnection(InetSocketAddress address, boolean timeout)
    {
        socket = new Socket();
    ...
    AndroidSocketConnection(InetSocketAddress address, boolean timeout,Proxy proxy)
    {
