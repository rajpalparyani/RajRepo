...
/**
 * @author chrbu
 * @date 2012-10-29 To fix the moving too fast bug on flipping found by UX
 */
public class OneStepGallery extends Gallery
{
    public OneStepGallery(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initCustomGallery(context);
    }

    public OneStepGallery(Context context, AttributeSet attrs) {
        super(context, attrs);
        initCustomGallery(context);
    }
