...
public class SendMessageServlet extends BaseServlet
{
    ...
    static final String PARAMETER_URL = "url";

    static final String PARAMETER_MSG = "msg";
            ...
            throws IOException
    {
        ...
        String msg = req.getParameter(PARAMETER_MSG);
        if (regId != null)
        {
            sendSingleMessage(regId, url, msg, resp);
            return;
        }
    ...
    private void sendSingleMessage(String regId, String url, String msg,
