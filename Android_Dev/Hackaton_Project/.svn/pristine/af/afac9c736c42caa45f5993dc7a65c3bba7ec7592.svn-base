 ...
 * @since 1.4
 */
public class Base64OutputStream extends OutputStream implements TnBase64OutputStream
{
    ...
    /**
     * Writes <code>len</code> bytes from the specified <code>b</code> array starting at <code>offset</code> to
     * this output stream.
     * 
