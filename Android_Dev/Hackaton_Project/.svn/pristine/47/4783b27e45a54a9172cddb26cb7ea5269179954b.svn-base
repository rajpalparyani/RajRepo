 ...
 * 
 * <ul>
 * <li><code>US-ASCII</code><br/> Seven-bit ASCII, a.k.a. ISO646-US, a.k.a. the Basic Latin block of the Unicode
 * character set.</li>
 ...
 * <li><code>UTF-16</code><br/> Sixteen-bit Unicode Transformation Format, byte order specified by a mandatory
 * initial byte-order mark (either order accepted on input, big-endian used on output.)</li>
 * </ul>
 * 
