...
interface ITrafficConstants extends ICommonConstants
{
    ...
    public static final int STATE_SEND_REROUTE = MASK_STATE_TRANSIENT | (STATE_USER_BASE + USER_BASE_TRAFFIC + 10);
    
    /**
     * Back to SummaryControlController and let SummaryControlController determine the to coming logic
     */
    public static final int STATE_BACK_TO_SUMMARY_CONTROLLER = MASK_STATE_TRANSIENT | (STATE_USER_BASE + USER_BASE_TRAFFIC + 11);
    
    public static final int STATE_RENEW_DYNAMIC_ROUTE = MASK_STATE_TRANSIENT | (STATE_USER_BASE + USER_BASE_TRAFFIC + 12);
        
    /**
     * Back to moving map screen.
     */
    public static final int STATE_GO_BACK = MASK_STATE_TRANSIENT | (STATE_USER_BASE + USER_BASE_TRAFFIC + 13);
    
    public static final int STATE_RENEW_STATIC_ROUTE = MASK_STATE_TRANSIENT | (STATE_USER_BASE + USER_BASE_TRAFFIC + 17);
...
//    public static final int ACTION_AVOID = 4;
    ...
    public static final int ACTION_RESUME_CALLBACK_DEVIATION = 18;
  ...
  //-----------------------------------------------------------
    ...
    public static final int ID_TRAFFIC_SUMMARY_MIDDLE_CONTAINER = 1003;
    ...
    public static final int ID_MINIMIZE_ALL_DELAY = 1010;
