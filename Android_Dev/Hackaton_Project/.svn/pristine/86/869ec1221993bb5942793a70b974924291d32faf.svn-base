...
public class JSONTokenerTest extends TestCase
{
    ...
    /***
     * Tests which characters tokener treats as ignorable whitespace. See Kevin Bourrillion's <a
     * href="https://spreadsheets.google.com/pub?key=pd8dAQyHbdewRsnE5x5GzKQ">list of whitespace characters</a>.
     */
...
//        assertNotClean("information separator 1", '\u001f');
    ...
    {
        assertEquals("The character " + name + " is not whitespace according to the JSON spec.", c, new JSONTokener(new String(new char[]
        { c, 'A' })).nextClean());
    }
    ...
    public void testNextToDoesntStopOnNull()
    {
        ...
        tokener = new JSONTokener("AB\nCDEF");
        assertEquals(message, "AB", tokener.nextTo("D"));
    }
