 ...
 */
public interface TnGL10 extends TnGL{
     ...
     */
    void glColorMask(boolean red, boolean green, boolean blue,
            boolean alpha);
     ...
     * <code>imageSize</code>.
     */
    void glCompressedTexSubImage2D(int target, int level, int xoffset,
     ...
     * @param height Specifies the height of the texture subimage.
     */
    void glCopyTexSubImage2D(int target, int level, int xoffset,
     ...
     * plane. The distance must be positive.
     */
    void glFrustumf(float left, float right, float bottom, float top,
     ...
     * @see #glFrustumf
     */
    void glFrustumx(int left, int right, int bottom, int top, int near,
            int far);
     ...
     */
    void glMultiTexCoord4f(int target, float s, float t, float r,
            float q);
     ...
     * to be behind the viewer.
     */
    void glOrthof(float left, float right, float bottom, float top,
            float near, float far);
     ...
     * @see #glOrthof
     */
    void glOrthox(int left, int right, int bottom, int top, int near,
            int far);
     ...
     */
    void glTexCoordPointer(int size, int type, int stride,
            Buffer pointer);
     ...
     * not contain the desired number of pixels.
     */
    void glTexSubImage2D(int target, int level, int xoffset,
