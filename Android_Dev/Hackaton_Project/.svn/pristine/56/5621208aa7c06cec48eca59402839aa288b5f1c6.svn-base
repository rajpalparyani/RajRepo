 ...
 * @date Jul 9, 2013
 */
public class NewSessionResponse extends DwfResponse
{
    ...
    public static final Parcelable.Creator<NewSessionResponse> CREATOR = new Parcelable.Creator<NewSessionResponse>()
    {
        public NewSessionResponse createFromParcel(Parcel in)
        {
            return new NewSessionResponse(in);
        }

        public NewSessionResponse[] newArray(int size)
        {
            return new NewSessionResponse[size];
        }
    };

    protected NewSessionResponse(Parcel in)
    {
        super(in);
