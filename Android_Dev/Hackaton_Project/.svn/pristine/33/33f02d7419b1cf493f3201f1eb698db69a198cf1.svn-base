 ...
 * RimHorizontalFieldManager.java
 *
 */
 ...
 *@date 2010-11-11
 */
public class RimHorizontalFieldManager extends HorizontalFieldManager implements INativeUiContainer
{
    ...
    public RimHorizontalFieldManager(AbstractTnComponent tnContainer, long style)
    {
        super(style);
